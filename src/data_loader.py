...
class DataLoader:
    ...
    def generate_sample_data(self, n_samples: int = 1000) -> pd.DataFrame:
        ...
        target_prob = 1 / (1 + np.exp(-(0.1 * feature1 + 0.15 * feature2 - 0.05 * feature3 - 5)))
    ...
    def prepare_features_target(self, df: pd.DataFrame, target_column: str = 'target') -> Tuple[pd.DataFrame, pd.Series]:
        """
