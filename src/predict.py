            ...
            if Path(self.model_path).exists():
                ...
                if Path(fallback_path).exists():
                    ...
                    raise FileNotFoundError(
                        f"Model not found at {self.model_path} or {fallback_path}"
                    )
...
def predict(
    data: Union[Dict, List[Dict]], model_path: str = "models/model.pkl"
) -> Dict:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, default="models/model.pkl", help="Path to model file"
    )
    ...
    if args.data:
        ...
        # Default example
        example_data = {"feature1": 45.5, "feature2": 28.3, "feature3": 22.1}
